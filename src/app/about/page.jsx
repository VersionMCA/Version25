...
export default function About() {
  ...
  return (
    <div
      className="w-full p-6 md:mt-20 lg:mt-32 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-xl"
      id="final"
    >
      <div className="hand ">
        <Image
          ...
          <ul className="text-xs sm:text-sm lg:text-md xl:text-lg  select-none font-mina opacity-80">
            <li>
              ...
              <li>
                ...
                interactions with industry experts. As the star event for MCA at
                NIT Trichy, it continues to be eagerly anticipated, drawing
              ...
              <li>
                ...
                forge connections, and leave an indelible mark on the landscape
                of MCA events. Get ready to celebrate innovation, talent, and
                camaraderie at the grand stage of Version 2025.
              </li>
            </li>
          </ul>
        </div>
        ...
        >
          <ul className="text-xs sm:text-sm lg:text-md xl:text-lg select-none font-mina opacity-80">
            <li>
              ...
              efficiency in software development through low-code innovation and
