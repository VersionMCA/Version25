...
function page(){
    return (
        <div className="inset-0  h-[100vh] flex items-center justify-evenly w-full" style={{background:'#0D0C0C'}}>
            ...
            <svg
              ...
              <p className="text-gray-700 text-lg leading-relaxed w-4/5" style={{color:'#BFF205'}}>
                ...
                Quas aperiam porro numquam necessitatibus dolor reprehenderit fuga 
                vitae accusamus quos! Pariatur fuga repellendus enim debitis unde dolor quas officiis dolorum quae.
              </p>
