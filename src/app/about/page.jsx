  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-300 flex flex-col">
      ...
      <main className="flex-grow p-6">
        {activeTab === "about" && (
          <div>
            ...
            <p>
              Embarking on its 31st edition, Version 2024, the annual All India
              MCA meet hosted by the students of NIT Trichy, stands as the
              pinnacle event for MCA students nationwide.
            </p>
          </div>
        )}
        {activeTab === "events" && (
      ...
      <footer className="bg-gray-800 py-4 text-center fixed bottom-0 left-0 w-full">
        <p className="text-sm">
          Made With Love 💖 By Version Web Team | © 2024 Version
        </p>
      </footer>
    </div>
  );
