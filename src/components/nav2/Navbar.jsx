...
const Navbar = ({toggle}) => {
  return (
      ...
      <div className = "p-2 lg:p-4 m-auto flex flex-row gap-0 md:gap-2 justify-center items-center text-md lg:text-xl sticky pixie z-[99]">
        ...
        <ul className = "flex flex-row items-center bg-[#94dc18] p-2 lg:p-4 basis-full rounded-full text-black ">
          ...
          <span className = "flex flex-row items-center justify-center basis-1/2">
            <li className = "mx-4 xl:mx-8  hidden lg:block"> <Link href="/">
                  <p>Home</p>
                </Link></li>
