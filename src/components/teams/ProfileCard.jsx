const ProfileCard = ({ name, image, socialLinks }) => {
  return (
    <div className = " rounded-lg aspect-[1/1] overflow-hidden xl:w-1/4 flex justify-center  items-center flex-col relative select-none bg-[#1E1E1E] border-double hover:border-l-8 hover:border-t-8 hover:border-l-[#b7f625] hover:border-t-[#b7f625] transition-all ease-in-out">
