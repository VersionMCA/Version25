        ...
        <div className="flex flex-col gap-12">
          <div className="flex flex-col text-center">
            <h2 className="font-semibold text-3xl md:text-4xl tracking-tighter">
              Welcome to{" "}
              <span className="font-bold bg-gradient-to-b from-primary to-primary bg-clip-text text-transparent tracking-tighter">
                Version'25
              </span>
            </h2>
            <p className="font-medium tracking-tighter text-muted-foreground text-lg md:text-xl">
              Log in to register for events!
            </p>
          </div>
          <div className="flex flex-col gap-4">
            <div
              className="w-full flex gap-2 p-4 font-medium md:text-lg rounded-xl hover:-translate-y-2 transition-all duration-300 cursor-pointer bg-gradient-to-b from-primary to-primary text-theme-black justify-center items-center"
              onClick={async () => {
                await signIn("google");
              }}
            >
