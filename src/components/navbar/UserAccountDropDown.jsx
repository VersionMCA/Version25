  ...
  return (
    <DropdownMenu onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="bg-secondary/15  hover:bg-secondary/25 flex items-center gap-2 rounded-xl px-2 py-2 shadow-sm transition-all duration-200 hover:shadow-md"
        >
          <div className="border-primary/20 h-10 w-10 md:h-12 md:w-12  overflow-hidden rounded-full border-2">
            {user.image ? (
