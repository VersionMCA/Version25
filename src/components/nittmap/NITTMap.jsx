...
const NITTrichyMap = () => {
    useEffect(() => {
        ...
        const locations = [
            ...
            { name: "Diamond Hostel", coords: [10.763505023095314, 78.81442345517546] },
            { name: "Emerald Hostel", coords: [10.763473404619923, 78.81638255989726] },
    ...
    return <div id="map" className="h-[500px] w-[500px] border-solid border-2 border-yellow-500 overflow-hidden" />
}
